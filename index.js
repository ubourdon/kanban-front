...
(function($PS) {
  "use strict";
  $PS["Board.Model"] = $PS["Board.Model"] || {};
  var exports = $PS["Board.Model"];
  var Data_Eq = $PS["Data.Eq"];
  var OpenCard = (function () {
      function OpenCard(value0) {
          this.value0 = value0;
      };
      OpenCard.create = function (value0) {
          return new OpenCard(value0);
      };
      return OpenCard;
  })();
  ...
  var DropCard = (function () {
      function DropCard(value0) {
          this.value0 = value0;
      };
      DropCard.create = function (value0) {
          return new DropCard(value0);
      };
      return DropCard;
  })();
  ...
  var OpenCreateCardPanel = (function () {
      function OpenCreateCardPanel() {

      };
      OpenCreateCardPanel.value = new OpenCreateCardPanel();
      return OpenCreateCardPanel;
  })();
  var CancelAction = (function () {
      function CancelAction() {

      };
      CancelAction.value = new CancelAction();
      return CancelAction;
  })();       
  var eqCardUid = Data_Eq.eqString;
  ...
  exports["OpenCreateCardPanel"] = OpenCreateCardPanel;
  exports["CancelAction"] = CancelAction;
  exports["eqCardUid"] = eqCardUid;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  ...
  var zIndex = (function () {
      var $86 = CSS_Stylesheet.key(CSS_Property.valString)(CSS_String.fromString(CSS_Property.isStringKey)("z-index"));
      var $87 = Data_Show.show(Data_Show.showInt);
      return function ($88) {
          return $86($87($88));
      };
  })();
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utils.FunctionOps"] = $PS["Utils.FunctionOps"] || {};
  var exports = $PS["Utils.FunctionOps"];
  var thrush = function (x) {
      return function (y) {
          return y(x);
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Board.View"] = $PS["Board.View"] || {};
  var exports = $PS["Board.View"];
  var Board_Model = $PS["Board.Model"];
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Utils_FunctionOps = $PS["Utils.FunctionOps"];
  var Web_HTML_Event_DragEvent = $PS["Web.HTML.Event.DragEvent"];                
  var opacity = CSS_Stylesheet.key(CSS_Property.valString)(CSS_String.fromString(CSS_Property.isStringKey)("opacity"));
  var hex = function (s) {
      return Data_Maybe.fromMaybe(Color_Scheme_Clrs.red)(Color.fromHexString(s));
  };
  var gridColumnProperty = CSS_Stylesheet.key(CSS_Property.valString)(CSS_String.fromString(CSS_Property.isStringKey)("grid-template-columns"));
  var gridColumn = CSS_Stylesheet.key(CSS_Property.valString)(CSS_String.fromString(CSS_Property.isStringKey)("grid-column"));
  var cursorProperty = (function () {
      var prop = CSS_Stylesheet.key(CSS_Property.valString)(CSS_String.fromString(CSS_Property.isStringKey)("cursor"));
      return prop("pointer");
  })();
  var createCard = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)((function () {
          if (state.openCard) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.pct(0.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.pct(0.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.pct(100.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.black))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.zIndex(1999))(function () {
                                      return opacity("0.5");
                                  });
                              });
                          });
          ...
          return new Data_Maybe.Just(Board_Model.CancelAction.value);
      }) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)((function () {
          if (state.openCard) {
              return CSS_Display.display(CSS_Display.block);
          };
          return CSS_Display.display(CSS_Display.displayNone);
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.pct(50.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.pct(50.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(40.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.zIndex(2000))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(hex("#ebecf0")))(function () {
                                  return CSS_Border.border(CSS_Border.outset)(CSS_Size.px(3.0))(hex("#555555"));
                              });
                          });
                      });
                  });
      ...
      })) ])([ Halogen_HTML_Elements.h2([  ])([ Halogen_HTML_Core.text("Cr\xe9er une carte") ]) ]) ]);
  };
  var card = function (c) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.white))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(CSS_Size.px(10.0))(CSS_Size.px(5.0))(CSS_Size.px(10.0))(CSS_Size.px(5.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.em(0.8)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)((function () {
                      if (c.isDrag) {
                          return CSS_Display.display(CSS_Display.displayNone);
                      };
                      return CSS_Display.display(CSS_Display.block);
                  })())(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Box.boxShadow(CSS_Size.px(0.0))(CSS_Size.px(1.0))(CSS_Size.px(0.0))(Color.rgba(9)(30)(66)(0.25)))(function () {
                          return cursorProperty;
                      });
                  });
              });
          });
      })), Halogen_HTML_Properties.draggable(true), Halogen_HTML_Events.onMouseUp(function (v) {
          return new Data_Maybe.Just(new Board_Model.OpenCard(c.uid));
      }), Halogen_HTML_Events.onDragStart(function (v) {
          return new Data_Maybe.Just(new Board_Model.DragStart(c.uid));
      }), Halogen_HTML_Events.onDragOver(function (v) {
          return new Data_Maybe.Just(new Board_Model.DragOver(c.uid));
      }), Halogen_HTML_Events.onDragEnd(function (v) {
          return new Data_Maybe.Just(new Board_Model.DragEnd(c.uid));
      }) ])([ Halogen_HTML_Core.text(c.title) ]);
  };
  var column = function (cards) {
      return function (i) {
          var cardForThisColumn = Data_List.filter(function (c) {
              return i === c.column;
          })(cards);
          return Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(gridColumn(Data_Show.show(Data_Show.showInt)(i)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(190.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.pct(96.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(hex("#ebecf0")))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginRight(CSS_Size.px(10.0)))(function () {
                              return CSS_Geometry.padding(CSS_Size.px(20.0))(CSS_Size.px(5.0))(CSS_Size.px(5.0))(CSS_Size.px(5.0));
                          });
                      });
                  });
              });
          })), Halogen_HTML_Events.onDragOver(function (e) {
              return Data_Maybe.Just.create(new Board_Model.PreventDefault(Web_HTML_Event_DragEvent.toEvent(e)));
          }), Halogen_HTML_Events.onDrop(function (v) {
              return new Data_Maybe.Just(new Board_Model.DropCard(i));
          }) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(hex("#172b4d")))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.px(14.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingLeft(CSS_Size.px(4.0)))(function () {
          ...
          })) ])([ Halogen_HTML_Core.text("colonne" + Data_Show.show(Data_Show.showInt)(i)) ]), Halogen_HTML_Elements.div([  ])(Utils_FunctionOps.thrush(Data_Functor.map(Data_List_Types.functorList)(card)(cardForThisColumn))(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))) ]);
      };
  };
  var columns = function (n) {
      return function (state) {
          var range = Data_Array.range(1)(n);
          return Data_Functor.map(Data_Functor.functorArray)(column(state.cards))(range);
      };
  };
  var view = function (state) {
      var columnsToDisplay = columns(2)(state);
      return Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(CSS_Background.backgroundColor(hex("#00aecc"))) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(CSS_Geometry.paddingLeft(CSS_Size.pct(2.0))) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(30.0)))(function () {
          return cursorProperty;
      })), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(Board_Model.OpenCreateCardPanel.value);
      }) ])([ Halogen_HTML_Core.text("Cr\xe9er une carte") ]) ]), createCard(state), Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(96.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vh(97.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(CSS_Size.pct(2.0))(CSS_Size.pct(2.0))(CSS_Size.pct(0.0))(CSS_Size.pct(2.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                      return gridColumnProperty("auto 1fr");
                  });
              });
          });
      })) ])(columnsToDisplay) ]);
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Board.Main"] = $PS["Board.Main"] || {};
  var exports = $PS["Board.Main"];
  var Board_Model = $PS["Board.Model"];
  var Board_View = $PS["Board.View"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var render = Board_View.view;
  var initialState = function (v) {
      return {
          cards: Utils_FunctionOps.thrush([ {
              uid: "12345",
              title: "US 12 - Super US de la mort",
              column: 1,
              isDrag: false
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          if (v instanceof Board_Model.OpenCard) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var openedCard = function (cards) {
                      return Data_Functor.map(Data_List_Types.functorList)(function (c) {
                          var $16 = Data_Eq.eq(Board_Model.eqCardUid)(c.uid)(v.value0);
                          if ($16) {
                              var $17 = {};
                              for (var $18 in c) {
                                  if ({}.hasOwnProperty.call(c, $18)) {
                                      $17[$18] = c[$18];
                                  };
                              };
                              $17.title = c.title + " OPENED";
                              return $17;
                          };
                          return c;
                      })(cards);
                  ...
                  $20.cards = openedCard(st.cards);
                  return $20;
              });
          };
          if (v instanceof Board_Model.DragStart) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  return st;
              });
          };
          if (v instanceof Board_Model.DragOver) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var dragCard = function (cards) {
                      return Data_Functor.map(Data_List_Types.functorList)(function (c) {
                          var $25 = Data_Eq.eq(Board_Model.eqCardUid)(c.uid)(v.value0);
                          if ($25) {
                              var $26 = {};
                              for (var $27 in c) {
                                  if ({}.hasOwnProperty.call(c, $27)) {
                                      $26[$27] = c[$27];
                                  };
                              };
                              $26.isDrag = true;
                  ...
                  $29.cards = dragCard(st.cards);
                  return $29;
              });
          };
          if (v instanceof Board_Model.DragEnd) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var dragCard = function (cards) {
                      return Data_Functor.map(Data_List_Types.functorList)(function (c) {
                          var $33 = Data_Eq.eq(Board_Model.eqCardUid)(c.uid)(v.value0);
                          if ($33) {
                              var $34 = {};
                              for (var $35 in c) {
                                  if ({}.hasOwnProperty.call(c, $35)) {
                                      $34[$35] = c[$35];
                                  };
                              };
                              $34.isDrag = false;
                  ...
                  $37.cards = dragCard(st.cards);
                  return $37;
              });
          };
          if (v instanceof Board_Model.DropCard) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var draggedCard = function (cards) {
                      return Data_Functor.map(Data_List_Types.functorList)(function (c) {
                          if (c.isDrag) {
                              var $42 = {};
                              for (var $43 in c) {
                                  if ({}.hasOwnProperty.call(c, $43)) {
                                      $42[$43] = c[$43];
                                  };
                              };
                              $42.column = v.value0;
                  ...
                  $45.cards = draggedCard(st.cards);
                  return $45;
              });
          };
          if (v instanceof Board_Model.PreventDefault) {
          ...
          if (v instanceof Board_Model.OpenCreateCardPanel) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $50 = {};
                  for (var $51 in st) {
          ...
          if (v instanceof Board_Model.CancelAction) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $53 = {};
                  for (var $54 in st) {
          ...
          throw new Error("Failed pattern match at Board.Main (line 29, column 16 - line 64, column 45): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Board_Main.component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();